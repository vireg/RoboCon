...
#define PNUE1                                      // piston moves up by 10 cm
#define PNUE2                                      //piston moves down by 15 cm
...
void setup ()
{
  ...
  Herkulex34.beginSerial2 (115200);
  ...
  switch (mod)
  {
    ...
    case 1: // Code for see-saw
            ...
            if (count1 == 0)
            {
              ...
              Herkulex12.moveOneAngle (n1,-10,200,LED_PINK);
              Herkulex12.moveOneAngle (n2,-10,200,LED_PINK);
              Herkulex34.moveOneAngle (n3,10,200,LED_PINK);
              Herkulex34.moveOneAngle (n4,10,200,LED_PINK);
              count1 = 1;
            }
            ...
            else if (pwm > 1600)
            {
               ...
               Herkulex12.moveOneAngle (n1,0,200,LED_PINK);
               Herkulex12.moveOneAngle (n2,0,200,LED_PINK);
               Herkulex34.moveOneAngle (n3,0,200,LED_PINK);
               Herkulex34.moveOneAngle (n4,0,200,LED_PINK);
               count1 = 0;
               mod = 0;
            }
   ...
   case 2:  // Code for swing
            ...
            if (count1 == 0)
            {
              ...
              // Move motors by a small angle
              Herkulex12.moveOneAngle (n1,-10,200,LED_CYAN);
              Herkulex12.moveOneAngle (n2,-10,200,LED_CYAN);
              Herkulex34.moveOneAngle (n3,10,200,LED_CYAN);
              Herkulex34.moveOneAngle (n4,10,200,LED_CYAN);
              count1 = 1;
            }
            // Unclamping when a pwm of 250 is given to the Auto bot
            else if (pwm > 1600)
            {
               delay (1000);                           // for manual bot to take hold of auto bot
               // Move motors to initial position
               Herkulex12.moveOneAngle (n1,0,200,LED_CYAN);
               Herkulex12.moveOneAngle (n2,0,200,LED_CYAN;
               Herkulex34.moveOneAngle (n3,0,200,LED_CYAN);
               Herkulex34.moveOneAngle (n4,0,200,LED_CYAN);
               count1 = 0;
               mod = 0;
            }
   ...
   case 3:  // Code for pole-walk
            ...
            Herkulex12.moveOneAngle(n3,0,200,LED_GREEN);
            Herkulex12.moveOneAngle(n4,0,200,LED_GREEN); 
            ...
            delay (500);                                // Time for bot to stabilize after locking onto to the pole (needs to be calibrated)
            ...
            Herkulex12.moveOneAngle(n1,-45,200,LED_BLUE);
            Herkulex12.moveOneAngle(n2,-45,200,LED_BLUE);            
            
            delay (500);                                // Time to ensure the motors and bot have moved to the desired position (must be more than motor playtime)
+            
            ...
            Herkulex12.moveOneAngle(n1,135,200,LED_GREEN);
            Herkulex12.moveOneAngle(n2,135,200,LED_GREEN);
            
            // Move motors 3 and 4 to move auto bot
            Herkulex34.moveOneAngle(n3,-135,200,LED_GREEN);
            Herkulex34.moveOneAngle(n4,-135,200,LED_GREEN);
            ...
            // Move motors 1 and 2 to move auto bot
            Herkulex12.moveOneAngle(n1,0,200,LED_BLUE);
            Herkulex12.moveOneAngle(n2,0,200,LED_BLUE);
            ...
            delay (500);                                // Time for bot to stabilize after locking onto to the pole (needs to be calibrated)
            // Move motors 3 and 4 to move auto bot
            Herkulex34.moveOneAngle(n3,0,200,LED_GREEN);
            Herkulex34.moveOneAngle(n4,0,200,LED_GREEN);
            Serial.println('Robot is on pole 4');
            
            delay (1000);                               // Time for manual to take hold of Auto bot (needs to be calibrated)
